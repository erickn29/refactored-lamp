...
export default {
  methods: {
    closeSlider() {
      ...
      let sliderWrapper = document.getElementById("leftSliderWrapper")
...
<template>
  <div class="base-wrapper" id="leftSliderWrapper" @click="closeSlider">
    <div class="wrapper p-4" id="leftSlider" style="">
      <div class="close mb-4" style="cursor: pointer;" @click="closeSlider">
      ...
      <div class="left-menu d-flex gap-4">
